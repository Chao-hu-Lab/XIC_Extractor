...
- Review the TSV before any deletion.
- Approve an exact group or exact path list before running `git rm`.
- Keep formal repo source-of-truth docs and the small migration index in version control.
- Do not keep same-path private-history stubs solely to avoid admitting that private development history moved to Obsidian.
...
### removal_candidate_no_repo_referrers

- `docs/deepresearch/Backfill Production Gate.md`
- `docs/superpowers/goals/2026-06-07-backfill-evidence-reconciliation-productization-goal.md`
...
- `docs/superpowers/notes/2026-05-26-p75-85raw-reentry-validation-note.md`
- `docs/superpowers/notes/2026-05-26-p8b-85raw-superwindow-acceptance-note.md`
- `docs/superpowers/notes/2026-05-26-p8b-owner-backfill-superwindow-investigation-note.md`
...
- `docs/superpowers/notes/2026-06-01-phase6b-final-retirement-go-note.md`
...
- `docs/superpowers/notes/2026-06-04-chrom-peak-segment-overlay-evidence.md`
...
- `docs/superpowers/plans/2026-04-07-istd-tag-pairing-nl-fix.md`
- `docs/superpowers/plans/2026-05-03-output-maintainability-refactor.md`
- `docs/superpowers/plans/2026-05-04-local-minimum-parameter-optimization.md`
- `docs/superpowers/plans/2026-05-05-excel-review-visual-report.md`
- `docs/superpowers/plans/2026-05-08-weighted-evidence-confidence-scoring.md`
- `docs/superpowers/plans/2026-05-13-untargeted-drift-aware-owner-edge-plan.md`
- `docs/superpowers/plans/2026-05-13-untargeted-final-matrix-rescue-contract-plan.md`
- `docs/superpowers/plans/2026-05-14-matrix-identity-consolidation-v2-plan.md`
- `docs/superpowers/plans/2026-05-15-multi-nl-tag-and-artificial-adduct-plan.md`
- `docs/superpowers/plans/2026-05-16-targeted-benchmark-reliability-plan.md`
- `docs/superpowers/plans/2026-05-20-instrument-qc-sdolek-calibration-v1-plan.md`
- `docs/superpowers/plans/2026-05-21-instrument-qc-matrix-calibration-productization-plan.md`
- `docs/superpowers/plans/2026-05-21-instrument-qc-mid-long-term-calibration-gates-plan.md`
- `docs/superpowers/plans/2026-05-24-p1-resolver-default-real-data-validation.md`
- `docs/superpowers/plans/2026-05-24-resolver-default-switch-implementation.md`
- `docs/superpowers/plans/2026-05-25-evidence-chain-cost-control-implementation-plan.md`
- `docs/superpowers/plans/2026-05-25-p2-asls-baseline-shadow-implementation.md`
- `docs/superpowers/plans/2026-05-25-p4-area-uncertainty-formula-implementation.md`
- `docs/superpowers/plans/2026-05-26-p2b-asls-production-promotion-plan.md`
- `docs/superpowers/plans/2026-05-26-p7-stabilization-implementation-plan.md`
- `docs/superpowers/plans/2026-05-28-tiered-backfill-machine-decision-contract-implementation-plan.md`
...
- `docs/superpowers/plans/2026-05-29-shared-peak-identity-slice1-blast-radius-plan.md`
...
- `docs/superpowers/plans/2026-06-03-selected-full-envelope-quantitation-boundary-implementation-goal.md`
- `docs/superpowers/plans/2026-06-07-backfill-evidence-reconciliation-productization-plan.md`
- `docs/superpowers/plans/2026-06-08-peakhypothesis-backfill-promotion-policy.md`
- `docs/superpowers/plans/2026-06-09-matrix-only-backfill-activation.md`
...
- `docs/superpowers/reports/2026-06-15-current-capability-inventory-and-promotion-roadmap.md`
- `docs/superpowers/specs/2026-04-20-peak-scoring-tiered-design.md`
- `docs/superpowers/specs/2026-05-03-output-maintainability-design.md`
...
- `docs/superpowers/specs/2026-05-15-multi-nl-tag-and-artificial-adduct-contract.md`
- `docs/superpowers/specs/2026-05-15-owner-backfill-request-economics-spec.md`
...
- `docs/superpowers/specs/2026-05-16-targeted-benchmark-reliability-spec.md`
- `docs/superpowers/specs/2026-05-17-targeted-nl-dropout-convergence-spec.md`
- `docs/superpowers/specs/2026-05-18-area-integration-uncertainty-audit-gate.md`
- `docs/superpowers/specs/2026-05-18-region-first-safe-merge-validation-gate.md`
- `docs/superpowers/specs/2026-05-19-safe-merge-provenance-validation.md`
- `docs/superpowers/specs/2026-05-20-instrument-qc-phases-3-6-consolidated-spec-plan.md`
- `docs/superpowers/specs/2026-05-20-instrument-qc-sdolek-calibration-v1-spec.md`
- `docs/superpowers/specs/2026-05-20-low-ms1-coverage-review-module-deepening-spec.md`
- `docs/superpowers/specs/2026-05-21-instrument-qc-matrix-calibration-productization-spec.md`
- `docs/superpowers/specs/2026-05-22-untargeted-identity-coherence-controls-spec.md`
- `docs/superpowers/specs/2026-05-22-untargeted-identity-coherence-core-spec.md`
- `docs/superpowers/specs/2026-05-22-untargeted-identity-coherence-downstream-audit-boundary.md`
- `docs/superpowers/specs/2026-05-22-untargeted-identity-coherence-implementation-contract.md`
- `docs/superpowers/specs/2026-05-22-untargeted-identity-coherence-prototype-spec.md`
...
- `docs/superpowers/specs/2026-05-24-peak-pipeline-resolver-default-switch-spec.md`
...
- `docs/superpowers/specs/2026-06-16-shared-target-untarget-peak-identity-spine-spec.md`

### removal_candidate_after_historical_referrer_cleanup
