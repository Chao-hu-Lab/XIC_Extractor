...
- `tools/diagnostics/alignment_decision_report.py`、`single_dr_production_gate_decision_report.py`、`targeted_istd_benchmark.py`、`family_ms1_backfill_review_report.py`、`analyze_rt_normalization_anchors.py`、`family_ms1_overlay_plot.py` 已拆出 loading / report model / matching / summary / analysis / rendering / style 或 writing helpers。
