...
def build_level0_calibration_bundle(
    *,
    ...
    evidence_rows_tuple = tuple(evidence_rows)
    ...
    summary = _build_summary(
        bundle_id=bundle_id,
        rows=evidence_rows_tuple,
        missing_artifacts=tuple(missing_artifacts),
    )
    write_calibration_evidence_tsv(evidence_tsv, evidence_rows_tuple)
    write_calibration_evidence_summary_json(evidence_summary_json, summary)
    ...
    manifest = CalibrationBundleManifest(
        ...
        status_counts={
            "source_type": summary.counts_by_source_type,
            "coverage_status": summary.counts_by_coverage_status,
            "product_support_status": summary.counts_by_product_support_status,
            "calibration_eligible": summary.counts_by_calibration_eligible,
        },
        first_human_file="",
