"""P2 baseline truth audit domain logic for AsLS shadow gate targets.

Reusable loading, classification, models, summaries, plotting, and writers for
the diagnostic-only P2 baseline truth audit. The CLI entry point lives in
``tools/diagnostics/p2_baseline_truth_audit.py`` and only parses arguments and
orchestrates this module.
"""
